...
class WorkflowDefinition():
    ...
    def __init__(self, name: str, version: int, start_state: str, end_state: str, fields: FieldClass, states: List[WorkflowState], create_access_roles: List[str] = ['_all_'], process_init_check: WorkflowProcessInitCheck = None, auto_delete_after_end=False, ) -> None:
